...
function settings:draw()
  ...
  local settings_width, settings_height = 480, 360
  ...
  -- Draw tank let it has the same color with nemu
	love.graphics.draw(self.assets.select, settings_x + 35, (35 * self.selected_item) + settings_y + 53, math.rad(0), 0.3, 0.3)

  -- Draw title text  
  love.graphics.setColor(4 / 255, 169 / 255, 201 / 255)
  love.graphics.setFont(self.assets.title)
  love.graphics.print("Settings", settings_x + 80, settings_y + 20)

  -- Draw help text
  love.graphics.setFont(self.assets.help)
  love.graphics.setColor(230 / 255, 12 / 255, 98 / 255)
	love.graphics.print("Movement: [A] [W] [S] [D] Select: [SPACE] / [ENTER]", settings_x + 80, settings_y + settings_height - 30)

  -- Draw menu text
  love.graphics.setFont(self.assets.menu)
  for i, setting in ipairs(self.settings) do
    local setting_x, setting_y = settings_x + 80, settings_y + 50
    ...
    love.graphics.print(setting, setting_x, 35 * i + setting_y)
  end
end
